 ...
 void fetchGyms(int? memberId) async {
    await getMembershipssRepo.getMemberships(
      ...
      onSuccess: (memberships) {
        ...
        CustomSnackBar.success(title: "Memberships", message: "Memberships Fetched Successfully");
      },
      onError: (error) {
        // Handle error
        CustomSnackBar.error(title: "Memberships", message: "Failed to Fetch Memberships");
      },
    );
 }
}